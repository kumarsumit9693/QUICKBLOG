...
const Footer = () => {
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/3'>
      ...
      py-10 border-b border-gray-500/30 text-gray-500'>
        ...
        <div>
          ...
          <p className='max-w-[410px] mt-6'>Lorem ipsum dolor sit amet consectetur adipisicing 
            elit. Perspiciatis, voluptatibus culpa inventore cum ratione cumque rerum, adipisci 
            beatae doloribus placeat earum eius exercitationem voluptate quasi distinctio 
            possimus est officiis sint.</p>
        </div>
      ...
      80'>Copyright 2025 @ QuickBlog Sumit - All Right Reserved.</p>
    </div>
  )
}
